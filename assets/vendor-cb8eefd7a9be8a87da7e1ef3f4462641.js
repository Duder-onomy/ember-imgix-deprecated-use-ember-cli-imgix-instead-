...
var x=function(e){var t,n,r,i,o,s,a,u,l,c,p,f,h,d,m,g,y,v,b,_="sizzle"+1*new Date,w=e.document,E=0,x=0,O=se(),C=se(),S=se(),T=function(e,t){return e===t&&(p=!0),0},P={}.hasOwnProperty,R=[],A=R.pop,j=R.push,k=R.push,N=R.slice,D=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
return-1},M="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",L="[\\x20\\t\\r\\n\\f]",I="(?:\\\\.|[\\w-]|[^\0-\\xa0])+",F="\\["+L+"*("+I+")(?:"+L+"*([*^$|!~]?=)"+L+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+I+"))|)"+L+"*\\]",B=":("+I+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+F+")*)|.*)\\)|)",U=new RegExp(L+"+","g"),q=new RegExp("^"+L+"+|((?:^|[^\\\\])(?:\\\\.)*)"+L+"+$","g"),H=new RegExp("^"+L+"*,"+L+"*"),z=new RegExp("^"+L+"*([>+~]|"+L+")"+L+"*"),V=new RegExp("="+L+"*([^\\]'\"]*?)"+L+"*\\]","g"),W=new RegExp(B),G=new RegExp("^"+I+"$"),K={ID:new RegExp("^#("+I+")"),CLASS:new RegExp("^\\.("+I+")"),TAG:new RegExp("^("+I+"|[*])"),ATTR:new RegExp("^"+F),PSEUDO:new RegExp("^"+B),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+L+"*(even|odd|(([+-]|)(\\d*)n|)"+L+"*(?:([+-]|)"+L+"*(\\d+)|))"+L+"*\\)|)","i"),bool:new RegExp("^(?:"+M+")$","i"),needsContext:new RegExp("^"+L+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+L+"*((?:-\\d)?\\d*)"+L+"*\\)|)(?=[^-]|$)","i")},Q=/^(?:input|select|textarea|button)$/i,Y=/^h\d$/i,$=/^[^{]+\{\s*\[native \w/,X=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,J=/[+~]/,Z=new RegExp("\\\\([\\da-f]{1,6}"+L+"?|("+L+")|.)","ig"),ee=function(e,t,n){var r="0x"+t-65536
...
try{k.apply(R=N.call(w.childNodes),w.childNodes),R[w.childNodes.length].nodeType}catch(e){k={apply:R.length?function(e,t){j.apply(e,N.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}function oe(e,t,r,i){var o,a,l,c,p,d,y,v=t&&t.ownerDocument,E=t?t.nodeType:9
...
y=d.join(","),v=J.test(e)&&me(t.parentNode)||t}if(y)try{return k.apply(r,v.querySelectorAll(y)),r}catch(e){}finally{c===_&&t.removeAttribute("id")}}}return u(e.replace(q,"$1"),t,r,i)}function se(){var e=[]
...
for(a=e,u=[],l=r.preFilter;a;){for(s in n&&!(i=H.exec(a))||(i&&(a=a.slice(i[0].length)||a),u.push(o=[])),n=!1,(i=z.exec(a))&&(n=i.shift(),o.push({value:n,type:i[0].replace(q," ")}),a=a.slice(n.length)),r.filter)!(i=K[s].exec(a))||l[s]&&!(i=l[s](i))||(n=i.shift(),o.push({value:n,type:s,matches:i}),a=a.slice(n.length))
...
var Te=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,Pe=/<script|<style|<link/i,Re=/checked\s*(?:[^=]|=\s*.checked.)/i,Ae=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
...
if(u)for(c=a[a.length-1].ownerDocument,_.map(a,Ne),p=0;p<u;p++)l=a[p],pe.test(l.type||"")&&!Y.access(l,"globalEval")&&_.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?_._evalUrl&&_._evalUrl(l.src):v(l.textContent.replace(Ae,""),c,l))}return e}function Le(e,t,n){for(var r,i=t?_.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||_.cleanData(he(r)),r.parentNode&&(n&&_.contains(r.ownerDocument,r)&&de(he(r,"script")),r.parentNode.removeChild(r))
...
if("string"==typeof e&&!Pe.test(e)&&!fe[(ce.exec(e)||["",""])[1].toLowerCase()]){e=_.htmlPrefilter(e)
...
var St=/%20/g,Tt=/#.*$/,Pt=/([?&])_=[^&]*/,Rt=/^(.*?):[ \t]*([^\r\n]*)$/gm,At=/^(?:GET|HEAD)$/,jt=/^\/\//,kt={},Nt={},Dt="*/".concat("*"),Mt=r.createElement("a")
...
if(y.promise(O),d.url=((t||d.url||vt.href)+"").replace(jt,vt.protocol+"//"),d.type=n.method||n.type||d.method||d.type,d.dataTypes=(d.dataType||"*").toLowerCase().match(M)||[""],null==d.crossDomain){l=r.createElement("a")
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):function(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)}(e,t))}var P,R=function(e){function t(n,r){S(this,t)
...
return e.insertBefore(n.element,i,n.nextSibling),new t(new se(n.element,i),i)},t.prototype.update=function(e,t){return!!Te(t)&&(this.textNode.nodeValue=t,!0)},t}(Pe),ke=function(e){function t(){return Oe(this,t),Ee(this,e.apply(this,arguments))}return xe(t,e),t.insert=function(e,n,r){return new t(e.insertHTMLBefore(n.element,n.nextSibling,r))},t.prototype.update=function(e,t){var n,r,i
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):function(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)}(e,t))}function Ie(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Fe(e){return null==e||"function"!=typeof e.toString}function Be(e){return Fe(e)?"":String(e)}function Ue(e){return Fe(e)?"":Te(e)?e:Ce(e)?e.toHTML():Se(e)?e:String(e)}function qe(e){return Fe(e)?"":Te(e)?e:Ce(e)||Se(e)?e:String(e)}a.add(26,function(e,t){var n=t.op1
...
var n=Me(this,e.apply(this,arguments))
return n.type="optimized-trusting-append",n}return Le(t,e),t.prototype.normalize=function(e){return(0,n.map)(e,Ue)},t.prototype.insert=function(e,t,n){return Ae(e,t,n)},t.prototype.updateWith=function(e,t,n,r,i){return new Qe(n,r,i)},t}(He),Qe=function(e){function t(){Ie(this,t)
var n=Me(this,e.apply(this,arguments))
...
var Pt=new wt,Rt=new wt(1),At=r.Expressions
...
t.concat(r.length)}),Rt.add(Je.FunctionExpression,function(e,t){t.function(e[2])}),Pt.add(bt.Helper,function(e,t){var n=t.env,r=t.meta,i=e[1],o=e[2],s=e[3]
if(!n.hasHelper(i,r.templateMeta))throw new Error("Compile Error: "+i+" is not a helper")
t.compileArgs(o,s,!0),t.helper(n.lookupHelper(i,r.templateMeta))}),Pt.add(bt.Get,function(e,t){var n,r=e[1],i=e[2]
for(t.getVariable(r),n=0;n<i.length;n++)t.getProperty(i[n])}),Pt.add(bt.MaybeLocal,function(e,t){var n,r,i=e[1]
for(t.meta.asPartial?(n=i[0],i=i.slice(1),t.resolveMaybeLocal(n)):t.getVariable(0),r=0;r<i.length;r++)t.getProperty(i[r])}),Pt.add(bt.Undefined,function(e,t){return t.primitive(void 0)}),Pt.add(bt.HasBlock,function(e,t){t.hasBlock(e[1])}),Pt.add(bt.HasBlockParams,function(e,t){t.hasBlockParams(e[1])}),Pt.add(bt.ClientSideExpression,function(e,t){Rt.compile(e,t)})
...
for(i=0;i<u.length;i++)if(o=u[i],r.Statements.isComponent(o))s=o[1],this.env.hasComponentDefinition(s,e.templateMeta)?void 0===f&&s===n?(f=s,Ht(s,l,t,p),qt(o,p)):p.push(o):(void 0!==f?p.push([Bt.OpenElement,s]):(f=s,Ht(s,l,t,p)),qt(o,p))
...
return[r,i]}var Tn,Pn=function(){function e(t){_n(this,e),this.document=t,this.setupUselessElement()}return e.prototype.setupUselessElement=function(){this.uselessElement=this.document.createElement("div")},e.prototype.createElement=function(e,t){var n=void 0,r=void 0
...
return e.compile(n),n.compile()},e.CompiledStaticTemplate=nt,e.CompiledDynamicTemplate=rt,e.IAttributeManager=qn,e.AttributeManager=qn,e.PropertyManager=Hn,e.INPUT_VALUE_PROPERTY_MANAGER=Wn,e.defaultManagers=Fn,e.defaultAttributeManagers=Un,e.defaultPropertyManagers=Bn,e.readDOMAttr=function(e,t){var n=e.namespaceURI===wn,r=en(e,t),i=r.type,o=r.normalized
...
return n},e.ensureGuid=m,e.initializeGuid=d,e.Stack=w,e.DictSet=_,e.dict=b,e.EMPTY_SLICE=C,e.LinkedList=x,e.ListNode=function e(t){E(this,e),this.next=null,this.prev=null,this.value=t},e.ListSlice=O,e.A=T,e.EMPTY_ARRAY=P,e.HAS_NATIVE_WEAKMAP=S,e.unwrap=function(e){if(null==e)throw new Error("Expected value to be present")
...
t&&void 0!==t._computedProperties&&(t._computedProperties=void 0)}(e.constructor),"function"==typeof n.setup&&n.setup(e,t)):null==n?(l=r,!1===u?Object.defineProperty(e,t,{configurable:!0,enumerable:u,writable:!0,value:l}):e[t]=r):(l=n,Object.defineProperty(e,t,n)),s&&q(0,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,l),this}var Y=!1
...
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,(r.peekDeps(o,n)||0)-1),C(t,o,r)}function Ae(e,t){this.isDescriptor=!0
...
return s&&a===u?u:(L(e,t,r),s||Pe(this,e,t,r),i[t]=void 0===u?ae:u,I(e,t,r),u)},je.teardown=function(e,t,n){if(!this._volatile){var r=n.readableCache()
...
n.peekWatching(t)&&Pe(this,e,t,n)},t.prototype.teardown=function(e,t,n){n.peekWatching(t)&&Re(this,e,t,n)},t.prototype.willWatch=function(e,t,n){Pe(this,e,t,n)},t.prototype.didUnwatch=function(e,t,n){Re(this,e,t,n)},t.prototype.get=function(e,t){var n=Ee(e,this.altKey),r=de(e),i=r.writableCache()
return i[t]!==Ne&&(i[t]=Ne,Pe(this,e,t,r)),n},t.prototype.set=function(e,t,n){return Ce(e,this.altKey,n)},t.prototype.readOnly=function(){return this.set=Me,this},t.prototype.oneWay=function(){return this.set=Le,this},t}(K)
function Me(e,t){throw new r.Error("Cannot set read-only property '"+t+"' on object: "+n.inspect(e))}function Le(e,t,n){return Q(e,t,null),Ce(e,t,n)}De.prototype._meta=void 0,De.prototype.meta=Ae.prototype.meta
var Ie=[],Fe={}
...
e.sendEvent=d,e.isNone=Ge,e.isEmpty=Ke,e.isBlank=Qe,e.isPresent=function(e){return!Qe(e)},e.run=$e,e.ObserverSet=_,e.beginPropertyChanges=H,e.changeProperties=V,e.endPropertyChanges=z,e.overrideChains=q,e.propertyDidChange=I,e.propertyWillChange=L,e.PROPERTY_DID_CHANGE=k,e.defineProperty=Q,e.Descriptor=K,e._hasCachedComputedProperties=function(){Y=!0},e.watchKey=$,e.unwatchKey=X,e.ChainNode=se,e.finishChains=function(e){var t=e.readableChainWatchers()
...
for(n=0;n<r.length;n++)i=r[n],Ce(e,i,t[i])}),t)},e.expandProperties=Te,e.addObserver=P,e.removeObserver=R,e._addBeforeObserver=A,e._removeBeforeObserver=j,e.Mixin=mt,e.aliasMethod=function(e){return new bt(e)},e._beforeObserver=function(){for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
Object.defineProperty(e,"mapBy",{enumerable:!0,get:function(){return P.mapBy}}),Object.defineProperty(e,"filter",{enumerable:!0,get:function(){return P.filter}}),Object.defineProperty(e,"filterBy",{enumerable:!0,get:function(){return P.filterBy}}),Object.defineProperty(e,"uniq",{enumerable:!0,get:function(){return P.uniq}}),Object.defineProperty(e,"uniqBy",{enumerable:!0,get:function(){return P.uniqBy}}),Object.defineProperty(e,"union",{enumerable:!0,get:function(){return P.union}}),Object.defineProperty(e,"intersect",{enumerable:!0,get:function(){return P.intersect}}),Object.defineProperty(e,"collect",{enumerable:!0,get:function(){return P.collect}}),Object.defineProperty(e,"Controller",{enumerable:!0,get:function(){return R.default}}),Object.defineProperty(e,"ControllerMixin",{enumerable:!0,get:function(){return A.default}}),Object.defineProperty(e,"Service",{enumerable:!0,get:function(){return j.default}}),Object.defineProperty(e,"RSVP",{enumerable:!0,get:function(){return k.default}}),Object.defineProperty(e,"onerrorDefault",{enumerable:!0,get:function(){return k.onerrorDefault}}),Object.defineProperty(e,"isArray",{enumerable:!0,get:function(){return N.isArray}}),Object.defineProperty(e,"typeOf",{enumerable:!0,get:function(){return N.typeOf}}),Object.defineProperty(e,"getStrings",{enumerable:!0,get:function(){return D.getStrings}}),Object.defineProperty(e,"setStrings",{enumerable:!0,get:function(){return D.setStrings}})}),e("ember-runtime/inject",["exports","ember-metal","ember-debug"],function(e,t,n){"use strict"
...
P.prototype.add=function(e,t){var n,r,i,o,s,a,u,l=this.rootState,c="^",p=[0,0,0],f=new Array(e.length),h=[],d=!0,m=0
...
f[n]={handler:r.handler,names:o,shouldDecodes:s}}d&&(l=l.put(47,!1,!1),c+="/"),l.handlers=f,l.pattern=c+"$",l.types=p,"object"==typeof t&&null!==t&&t.as&&(u=t.as),u&&(this.names[u]={segments:h,handlers:f})},P.prototype.handlersFor=function(e){var t,n,r=this.names[e]
...
for(g.length=f.length,r=0;r<f.length;r++){if(o=(i=f[r]).names,s=i.shouldDecodes,a=b,u=!1,o!==_&&s!==_)for(l=0;l<o.length;l++)u=!0,c=o[l],p=d&&d[m++],a===b&&(a={}),P.ENCODE_AND_DECODE_PATH_SEGMENTS&&s[l]?a[c]=p&&decodeURIComponent(p):a[c]=p
...
e===t?S(e,t):(r=typeof(n=t),null===n||"object"!==r&&"function"!==r?S(e,t):x(e,t,v(t)))}function C(e){e._onError&&e._onError(e._result),R(e)}function S(e,t){e._state===h&&(e._result=t,e._state=d,0===e._subscribers.length?a.instrument&&c("fulfilled",e):a.async(R,e))}function T(e,t){e._state===h&&(e._state=m,e._result=t,a.async(C,e))}function P(e,t,n,r){var i=e._subscribers,o=i.length
...
return a.instrument&&c("chained",this,o),i===h?P(this,o,e,t):(r=i===d?e:t,a.async(function(){return A(i,o,r,s)})),o}var k=function(){function e(e,t,n,r){this._instanceConstructor=e,this.promise=new e(f,r),this._abortOnReject=n,this.isUsingOwnPromise=e===L,this._init.apply(this,arguments)}return e.prototype._init=function(e,t){var n=t.length||0
...
var F=new I,B=new I
function U(e,t,n){try{e.apply(t,n)}catch(e){return F.value=e,F}}function q(e,t){return{then:function(n,r){return e.call(t,n,r)}}}function H(e,n){var r=function(){var t,r,i,o=arguments.length,s=new Array(o+1),a=!1
for(t=0;t<o;++t){if(r=arguments[t],!a){if((a=z(r))===B)return T(i=new L(f),B.value),i
...
function Pe(){a.on.apply(a,arguments)}function Re(){a.off.apply(a,arguments)}if("undefined"!=typeof window&&"object"==typeof window.__PROMISE_INSTRUMENTATION__)for(var Ae in i=window.__PROMISE_INSTRUMENTATION__,u("instrument",!0),i)i.hasOwnProperty(Ae)&&Pe(Ae,i[Ae])
var je=((r={asap:ce,cast:Se,Promise:L,EventTarget:s,all:V,allSettled:G,race:K,hash:$,hashSettled:J,rethrow:Z,defer:ee,denodeify:H,configure:u,on:Pe,off:Re,resolve:re,reject:ie,map:ne}).async=Te,r.filter=ae,r)
e.asap=ce,e.cast=Se,e.Promise=L,e.EventTarget=s,e.all=V,e.allSettled=G,e.race=K,e.hash=$,e.hashSettled=J,e.rethrow=Z,e.defer=ee,e.denodeify=H,e.configure=u,e.on=Pe,e.off=Re,e.resolve=re,e.reject=ie,e.map=ne,e.async=Te,e.filter=ae,e.default=je}),t("ember")}(),"undefined"==typeof FastBoot&&function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t(e):"function"==typeof define&&define.amd?define(t):t(e)}("undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:this,function(e){"use strict"
var t,n=e.Base64
...
return[r.charAt(n>>>18),r.charAt(n>>>12&63),t>=2?"=":r.charAt(n>>>6&63),t>=1?"=":r.charAt(63&n)].join("")},c=e.btoa?function(t){return e.btoa(t)}:function(e){return e.replace(/[\s\S]{1,3}/g,l)},p=t?t.from&&t.from!==Uint8Array.from?function(e){return(e.constructor===t.constructor?e:t.from(e)).toString("base64")}:function(e){return(e.constructor===t.constructor?e:new t(e)).toString("base64")}:function(e){return c(u(e))},f=function(e,t){return t?p(String(e)).replace(/[+\/]/g,function(e){return"+"==e?"-":"_"}).replace(/=/g,""):p(String(e))},h=new RegExp(["[À-ß][-¿]","[à-ï][-¿]{2}","[ð-÷][-¿]{3}"].join("|"),"g"),d=function(e){switch(e.length){case 4:var t=((7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3))-65536
...
if(e.Base64={VERSION:"2.4.3",atob:y,btoa:c,fromBase64:b,toBase64:f,utob:u,encode:f,encodeURI:function(e){return f(e,!0)},btou:m,decode:b,noConflict:function(){var t=e.Base64
...
Object.defineProperty(e,"__esModule",{value:!0}),Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}),define("ember-imgix/components/imgix-image/component-integration-test",["ember-qunit"],function(e){"use strict";(0,e.moduleForComponent)("imgix-image","Integration | Component | imgix image",{integration:!0}),(0,e.test)("it renders",function(e){this.render(Ember.HTMLBars.template({id:"2TgUSzKi",block:'{"symbols":[],"statements":[[1,[18,"imgix-image"],false]],"hasEval":false}',meta:{}})),e.ok(this.$())}),(0,e.test)("it renders event more better",function(e){this.render(Ember.HTMLBars.template({id:"E1cxjPUT",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:200px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path"],["/users/1.png"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=new URL(this.$("img").attr("src"))
e.equal(this.$().text().trim(),""),e.equal(t.pathname,"/users/1.png")}),(0,e.test)("it allows setting the alt attribute",function(e){this.render(Ember.HTMLBars.template({id:"EuUudROn",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:200px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path","alt"],["/users/1.png","User 1"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=this.$("img").attr("alt")
e.equal(t,"User 1")}),(0,e.test)("it renders the correct path",function(e){this.render(Ember.HTMLBars.template({id:"E1cxjPUT",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:200px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path"],["/users/1.png"]]],false],[8]],"hasEval":false}',meta:{}})),e.ok(this.$("img").attr("src").indexOf("https://assets.imgix.net/users/1.png")>-1),e.ok(this.$("img").attr("src").indexOf("w=200")>-1)}),(0,e.test)("it builds the default URL",function(e){this.render(Ember.HTMLBars.template({id:"5iortMGp",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path"],["/users/1.png"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=new URL(this.$("img").attr("src"))
e.equal(t.searchParams.get("w"),"1280"),e.equal(t.pathname,"/users/1.png"),e.equal(t.searchParams.get("fit"),"crop"),e.equal(t.searchParams.get("crop"),"faces")}),(0,e.test)("it maintains any query parameters passed in",function(e){this.render(Ember.HTMLBars.template({id:"N9FjatVB",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path"],["/users/1.png?sat=100"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=new URL(this.$("img").attr("src"))
e.equal(t.searchParams.get("sat"),"100"),e.equal(t.searchParams.get("w"),"1280")}),(0,e.test)("it renders with an aspect ratio",function(e){this.render(Ember.HTMLBars.template({id:"C5n/Hj1n",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path","aspectRatio"],["/users/1.png",1.3333]]],false],[8]],"hasEval":false}',meta:{}})),e.equal(this.$().text().trim(),"")
var t=new URL(this.$("img").attr("src"))
e.equal(t.searchParams.get("w"),"1280"),e.equal(t.searchParams.get("h"),"960")}),(0,e.test)("it respects passed in `crop` and `fit` values",function(e){e.expect(2),this.render(Ember.HTMLBars.template({id:"GhSkCNr/",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path"],["/users/1.png?sat=100&fit=min&crop=top,left"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=new URL(this.$("img").attr("src"))
e.equal(t.searchParams.get("fit"),"min"),e.equal(t.searchParams.get("crop"),"top,left")}),(0,e.test)("it respects `crop` and `fit` values passed as attributes",function(e){e.expect(2),this.render(Ember.HTMLBars.template({id:"52KUZHCo",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path","crop","fit"],["/users/1.png","top,left","min"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=new URL(this.$("img").attr("src"))
e.equal(t.searchParams.get("crop"),"top,left"),e.equal(t.searchParams.get("fit"),"min")}),(0,e.test)("it respects `auto` values passed as attributes",function(e){e.expect(1),this.render(Ember.HTMLBars.template({id:"9zc4s9x/",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path","auto"],["/users/1.png","compress,enhance"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=new URL(this.$("img").attr("src"))
e.equal(t.searchParams.get("auto"),"compress,enhance")}),(0,e.test)("it allows setting the alt attribute",function(e){this.render(Ember.HTMLBars.template({id:"Mejjhp0p",block:'{"symbols":[],"statements":[[6,"div"],[9,"style","width:1280px;height:200px;"],[7],[1,[25,"imgix-image",null,[["path","alt"],["/users/1.png","User 1"]]],false],[8]],"hasEval":false}',meta:{}}))
var t=this.$("img").attr("alt")
e.equal(t,"User 1")})}),define("ember-imgix/components/imgix-image/component",["exports","ember-resize-aware/mixins/resize-aware","ember-get-config","imgix-core-js"],function(e,t,n,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(t.default,{layout:null,tagName:"img",attributeBindings:["src","crossorigin","style","alt"],unifiedEventHandler:Ember.inject.service(),aspectRatio:null,path:null,crop:"faces",fit:"crop",pixelStep:10,onLoad:null,auto:null,alt:null,width:null,height:null,_width:null,_height:null,debounceRate:400,didResize:function(e,t){var n=Math.ceil(Ember.get(this,"_pathAsUrl.searchParams").get("width")||e/Ember.get(this,"pixelStep"))*Ember.get(this,"pixelStep"),r=Math.floor(Ember.get(this,"aspectRatio")?n/Ember.get(this,"aspectRatio"):Ember.get(this,"_pathAsUrl.searchParams").get("height")||t),i=window.devicePixelRatio||1
Ember.set(this,"_width",n),Ember.set(this,"_height",r),Ember.set(this,"_dpr",i)},didInsertElement:function(){this._handleImageLoad=this._handleImageLoad.bind(this),Ember.get(this,"unifiedEventHandler").register("#"+this.elementId,"load",this._handleImageLoad),this.didResize(Ember.get(this,"width")||Ember.get(this,"_width")||this.element.clientWidth||this.element.parentElement.clientWidth,Ember.get(this,"height")||Ember.get(this,"_height")||this.element.clientHeight||this.element.parentElement.clientHeight),this._super.apply(this,arguments)},willDestroyElement:function(){Ember.get(this,"unifiedEventHandler").unregister("#"+this.elementId,"load",this._handleImageLoad),this._super.apply(this,arguments)},_pathAsUrl:Ember.computed("path",function(){return new window.URL(Ember.get(this,"path"),"https://"+n.default.APP.imgix.source)}),_client:Ember.computed(function(){if(!n.default||!Ember.get(n.default,"APP.imgix.source"))throw new Ember.Error("Could not find a source in the application configuration. Please configure APP.imgix.source in config/environment.js. See https://github.com/imgix/ember-imgix for more information.")
return new r.default({host:n.default.APP.imgix.source})}),src:Ember.computed("_pathAsUrl","_width","_height","_dpr","crop","fit",function(){if(Ember.get(this,"_width")){var e={crop:Ember.get(this,"crop"),fit:Ember.get(this,"fit"),w:Ember.get(this,"_width"),h:Ember.get(this,"_height"),dpr:Ember.get(this,"_dpr")}
this.get("auto")&&Ember.merge(e,{auto:this.get("auto")})
...
Ember.get(this,"unifiedEventHandler").unregister("#"+this.elementId,"load",this._handleImageLoad),Ember.run.next(this,function(){return Ember.tryInvoke(t,"onLoad",[e.originalEvent])})},_debugParams:Ember.computed("_width","_height","_dpr",function(){return{txt64:Ember.get(this,"_width")+" x "+Ember.get(this,"_height")+" @ DPR "+Ember.get(this,"_dpr"),txtalign:"center,bottom",txtsize:20,txtfont:"Helvetica Neue",txtclr:"ffffff",txtpad:20,txtfit:"max",exp:-2}})})})

...
module.exports = {
  ...
  treeForVendor(vendorTree) {
    ...
    const imgixJs = FastbootTransform(new Funnel(path.dirname(require.resolve('imgix-core-js')), {
      files: ['imgix-core-js.js'],
      destDir: 'imgix-core-js',
    }));

    const jsBase64 = FastbootTransform(new Funnel(path.dirname(require.resolve('js-base64')), {
      files: ['base64.js'],
      destDir: 'js-base64',
    }))
